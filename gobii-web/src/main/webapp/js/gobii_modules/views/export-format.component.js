System.register(["@angular/core", "../model/type-extract-format", "../model/gobii-file-item", "../model/type-process", "../model//type-extractor-item", "../model/type-extractor-filter", "@ngrx/store", "../services/core/nameid-file-item-service", "rxjs/Observable", "../services/core/view-id-generator-service"], function (exports_1, context_1) {
    "use strict";
    ...
    var core_1, type_extract_format_1, gobii_file_item_1, type_process_1, type_extractor_item_1, type_extractor_filter_1, store_1, nameid_file_item_service_1, Observable_1, view_id_generator_service_1, ExportFormatComponent;
    return {
        setters: [
            function (core_1_1) {
                core_1 = core_1_1;
