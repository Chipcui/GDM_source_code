    ...
    return {
        ...
        execute: function () {
            DatasetDatatableComponent = (function () {
                function DatasetDatatableComponent(store, fileItemService, entityFileItemService, filterParamsColl, fileItemRequestService, viewIdGeneratorService) {
                    var _this = this;
                    this.store = store;
