    ...
    return {
        ...
        execute: function () {
            ExtractorRoot = (function () {
                function ExtractorRoot(_dtoRequestServiceContact, _authenticationService, _dtoRequestServiceServerConfigs, store, nameIdFileItemService, entityFileItemService, instructionSubmissionService, filterService, flexQueryService, changeDetectorRef, viewIdGeneratorService) {
                    var _this = this;
                    ...
                    this.gobiiEntityTypes = Object.assign({}, type_entity_1.EntityType);
